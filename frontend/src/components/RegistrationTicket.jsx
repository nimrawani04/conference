...
const fontImport = `
  ...
  @media print {
    ...
    body.registration-ticket-printing .ticket-test-shell,
    body.registration-ticket-printing .registration-success-shell,
    body.registration-ticket-printing footer {
...
in AI`}
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                ...
                <div style={{ borderTop: "1px solid #bbb", paddingTop: "14px", display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: "16px" }}>
                  ...
                  {/* QR Code — small, centered, no vertical bloat */}
                  {qrCodeUrl && (
                    <div style={{
                      ...
                      <img src={qrCodeUrl} alt="QR" style={{ width: "64px", height: "64px", display: "block" }} />
