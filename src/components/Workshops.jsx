...
function Workshops() {
  ...
  return (
    <PageLayout 
      ...
      subtitle="Hands-on workshop on June 17, 2026"
    >
      <div className="bg-white rounded shadow-sm p-12">
        <div className="flex flex-col items-center justify-center text-center min-h-[400px]">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mb-4">
            The pre-conference workshop will be held on June 17, 2026. Detailed information about workshop topics, speakers, and registration will be announced soon.
          </p>
